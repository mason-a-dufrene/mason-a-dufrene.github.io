var runLevels = function (window) {
  ...
  window.opspark.runLevelInGame = function (game) {
    ...
    function createSawBlade(x, y) {
      ...
      obstacleImage.y = sawBladeHitZone.y * -1 / 17
      obstacleImage.x = sawBladeHitZone.x * -1 / 18 + 15
    ...
    function createEnemy(x, y) {
      ...
      enemy.velocityX = -1
      enemy.onPlayerColision = function () {
    ...
    function createReward(x, y) {
      ...
      reward.velocityX = -1
      reward.onPlayerColision = function () {
        game.changeIntegrity(-10)
        shrink(reward);
      };
